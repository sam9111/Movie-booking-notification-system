...
while movie not in movies:
    ...
    movie=input("Which movie are you waiting for? (Enter quit to exit program.)\n").lower()
    ...
    if movie in movies:
        ...
        if actionbook:
            ...
            if actionbook.find('div',attrs={'class':'more-showtimes'}):
                ...
                message="Bookings are now open for "+movie.capitalize()+"\n"+"Book your tickets now at "+url2
                
                print('Bookings open for '+movie.capitalize()+'Email sent successfully!')
            ...
            #sending email via python            
                ...
                s.starttls()
                Sender_mail="sampython9111@gmail.com"
                Sender_mail_password="sweety123#"
                try:
